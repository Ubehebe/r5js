...
const {Datum, ProcCallLike, UNSPECIFIED_VALUE, appendProcCallLike, getLastProcCallLike} = require('/js/parse/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/datum');
...
const {PortManager} = require('/js/parse/shim_collect_es6_sources.es6/node_modules/__main__/js/parse/port_manager');
...
const {String: StringNode} = require('/js/parse/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/string');
...
const {CdrHelperImpl, DottedList, List} = require('/js/parse/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/list');
