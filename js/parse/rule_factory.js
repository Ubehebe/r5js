...
const {DesugarableRule} = require('/js/macro/shim_collect_es6_sources.es6/node_modules/__main__/js/macro/desugarable_rule');
...
const {Unquote} = require('/js/macro/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/unquote');
const {UnquoteSplicing} = require('/js/macro/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/unquote_splicing');
