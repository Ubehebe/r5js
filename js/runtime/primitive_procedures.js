...
const {Datum, ProcCallLike, UNSPECIFIED_VALUE, appendProcCallLike, getLastProcCallLike} = require('/js/macro/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/datum');
...
const {PortManager} = require('/js/macro/shim_collect_es6_sources.es6/node_modules/__main__/js/macro/port_manager');
...
const {String: StringNode} = require('/js/macro/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/string');
...
const {CdrHelperImpl, DottedList, List} = require('/js/macro/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/list');
