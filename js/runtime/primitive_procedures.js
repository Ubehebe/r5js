...
const {String: StringNode} = require('/js/ast/datum_collect_es6_sources.es6/node_modules/__main__/js/ast/string');
...
const {CdrHelperImpl, DottedList, List} = require('/js/ast/datum_collect_es6_sources.es6/node_modules/__main__/js/ast/list');
