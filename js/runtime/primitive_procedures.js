...
const {Datum, ProcCallLike, UNSPECIFIED_VALUE, appendProcCallLike, getLastProcCallLike} = require('/js/runtime/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/datum');
...
const {String: StringNode} = require('/js/runtime/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/string');
