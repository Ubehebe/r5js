...
const {Datum, ProcCallLike, UNSPECIFIED_VALUE, appendProcCallLike, getLastProcCallLike} = require('/js/read/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/datum');
...
const {PortManager} = require('/js/read/shim_collect_es6_sources.es6/node_modules/__main__/js/read/port_manager');
...
const {String: StringNode} = require('/js/read/shim_collect_es6_sources.es6/node_modules/__main__/js/ast/string');
